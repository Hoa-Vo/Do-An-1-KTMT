...
//--neu he 16 thi chuyen thanh he 2 roi luu vao data
	...
	//so sanh ==
	friend bool operator==(QInt x, QInt y);
	//Dich phai mang ket qua nhan
	friend void shiftRight(QInt& temp, QInt& q, bool& q1, bool result[]);
	//Gop mang
	friend void combineArray(QInt temp, QInt q, bool q1, bool result[]);
	//Tach mang
	friend void splitArray(bool result[], QInt& temp, QInt& q, bool& q1);
	//Dua ket qua nhan vao QInt va kiem tra tran so
	friend bool toQInt(bool result[], QInt& temp);
};
